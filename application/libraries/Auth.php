   ...
   if(!empty($data))

      {
         ...
         if ($cek_login==false) {
            ...
            echo "<script>alert('Anda telah keluar dari sistem'); window.location='".base_url()."login_a';</script>";

         }

      } else {

            echo "<script>alert('Anda harus login terlebih dahulu'); window.location='".base_url()."login_a';</script>";
