          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-blue"><br>
              	...
              	<h4 class="title">Pengunjung Lainnya</h4></center>
					...
					<center><a href="<?php echo site_url('register')?>" type="button"class="btn btn-primary btn-xs button1 animate__animated animate__fadeInUp">Ayo Daftar Sekarang Juga!!!</a><br><br></center>
        </div>
