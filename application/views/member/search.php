...
<title>"<?php echo $cara?>" - Hasil Pencarian Materi Belajar Ekspor - BelajarEkspor.id</title>
<meta name="description" content='Materi Belajar Ekspor "<?php echo $cara?>" - Bersama Coach Fernandes Raymond - BelajarEkspor.id' />
...
<section class="breadcrumbs">
  <div class="container">
	...
	<div class="d-flex justify-content-between align-items-center">
	  <h2>Hasil Pencarian '<?php echo $cara?>' :</h2>
	  ...
	  <?php
		...
		<article class="entry">
		  ...
		  <h2 class="entry-title2">
			<a href="<?php echo base_url('detail/'.$p->nama_kategori_materi.'/'. $p->judul_materi); ?>"><?php echo $p->judul_materi; ?></a>
		  </h2>

		  <div class="entry-footer">
		  <div class="entry-content">
			<p>
							<?php echo substr($p->isi_materi,0,300).'...' ?>
							</p>
			<div class="read-more">
	  ...
	  <div class="col-lg-4"  data-aos="fade-left">
		...
		<div class="sidebar">
		  ...
		  <div class="sidebar-item search-form">
			<form action="<?php echo base_url('c_materi/hasil')?>">
