									...
									<div class="col-md-12">
										...
										<div class="col-md-12">
											...
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" id="status_kategori_materi" name="status_kategori_materi" value="1" required>
												Aktif
												</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" id="status_kategori_materi2" name="status_kategori_materi" value="0" required>
