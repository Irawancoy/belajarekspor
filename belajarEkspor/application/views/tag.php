...
<head>
  ...
  <title>Materi Belajar Ekspor Tags "<?php echo $cara?>"  - BelajarEkspor.id</title>
<meta name="description" content='Materi Belajar Ekspor tag "<?php echo $cara?>" - Bersama Coach Fernandes Raymond - BelajarEkspor.id' />
